...
class DialogueManager extends FlxSubState {
    ...
    public function new(xmlPath:String, startDialogId:String, ?onComplete:Void->Void) {
        ...
        var rawXML = LilyAssets.getTextFromFile('dialogues/$xmlPath.xml');
        rawXML = StringTools.replace(rawXML, "<!DOCTYPE lily-engine-dialog>", "");
    ...
    override public function update(elapsed:Float):Void {
        ...
        if (waitingForInput && !selectionMenu.activeMenu && (Controls.ACCEPT_P || pointerJustPressed || touchJustPressed)) {
